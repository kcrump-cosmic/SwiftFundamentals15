...
if let janDays = monthDays["January"] {
...
let combinedDictionary: [String: [String]] = [
    "Shapes": shapesArray,
    "Colors": colorsArray
]
...
if let colors = combinedDictionary["Colors"], let lastColor = colors.last {
    print("The last color is: \(lastColor)")
} else {
    print("Could not find the Colors array or it is empty.")
}
