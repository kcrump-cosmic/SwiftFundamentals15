...
let favoriteBook = Book(title: "So This is Ever After", author: "F.T. Lukens", pages: 368, price: 20)

print("One of my favorite books is \(favoriteBook.title) by \(favoriteBook.author) which costs \(favoriteBook.price ) dollars and has \(favoriteBook.pages) pages")
...
let myLaptop1 = Laptop(yearPurchased: 2025)
let myLaptop2 = Laptop(yearPurchased: 2018)
